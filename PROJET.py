...
if form_selection == "Kobotoolbox":
    st.markdown("""
    <iframe src="https://ee.kobotoolbox.org/i/ya9GbL2S" width="800" height="1100" frameborder="0" marginheight="0" marginwidth="0">Chargement en cours...</iframe>
    """, unsafe_allow_html=True)
   
elif form_selection == "Google Forms":
    st.markdown("""
    <iframe src="https://forms.gle/X9vAp5GvaiunnUCi8" width="800" height="1100" frameborder="0" marginheight="0" marginwidth="0">Chargement en cours...</iframe>
    """, unsafe_allow_html=True)
